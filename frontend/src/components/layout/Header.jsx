...
import { Building2, Menu, X, User, LogOut, Settings, LayoutDashboard } from 'lucide-react'
              ...
              <div className="relative">
                ...
                {userDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border py-2 z-50">
                    <Link
                      to={user.role_type === 'admin' ? '/admin' : '/dashboard'}
          ...
          <div className="md:hidden mt-4 pt-4 border-t border-gray-200 bg-white rounded-lg shadow-lg p-4">
            ...
            <div className="pt-3 mt-2 border-t border-gray-200">
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-500">Language / ቋንቋ</span>
                <LanguageSwitcher />
              </div>
            </div>
          </div>
