...
export const buyerAuthAPI = {
  login: async (username, password) => {
    try {
      const response = await fetch(`${API_URL}/buyer/auth/login`, {
        method: 'POST',
  ...
  register: async (userData) => {
    try {
      const response = await fetch(`${API_URL}/buyer/auth/register`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
  ...
  getProfile: async () => {
    ...
    const response = await fetch(`${API_URL}/buyer/profile`, {
...
export const adminAPI = {
  ...
  // New: Get verification queue
  getVerificationQueue: async () => {
    const response = await api.get('/admin/verification-queue')
    return response.data
  },
  
  // New: Get payment approvals
  getPaymentApprovals: async () => {
    const response = await api.get('/admin/payment-approvals')
    return response.data
  },
  
  approvePayment: async (paymentId) => {
    const response = await api.post(`/admin/payment-approvals/${paymentId}/approve`)
    return response.data
  },
  
  rejectPayment: async (paymentId, reason) => {
    const response = await api.post(`/admin/payment-approvals/${paymentId}/reject`, { reason })
    return response.data
  },
}
...
export const buyerAPI = {
  getProperties: async (params = {}) => {
    ...
    const response = await fetch(`${API_URL}/buyer/properties?${queryParams}`, {
      headers: { 'Authorization': `Bearer ${token}` }
    })
    return response.json()
  },
  ...
  getProperty: async (id) => {
    const response = await fetch(`${API_URL}/buyer/properties/${id}`)
    return response.json()
  },
  
  getSavedProperties: async () => {
    const token = localStorage.getItem('access_token')
    const response = await fetch(`${API_URL}/buyer/saved-properties`, {
      headers: { 'Authorization': `Bearer ${token}` }
    })
    return response.json()
  },
  ...
  removeSavedProperty: async (listingId) => {
    const token = localStorage.getItem('access_token')
    const response = await fetch(`${API_URL}/buyer/saved-properties/${listingId}`, {
      method: 'DELETE',
      headers: { 'Authorization': `Bearer ${token}` }
    })
    return response.json()
  ...
  contactOwner: async (propertyId, message) => {
    const token = localStorage.getItem('access_token')
    const response = await fetch(`${API_URL}/buyer/contact-owner`, {
      method: 'POST',
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json'
  ...
  getConversations: async () => {
    const token = localStorage.getItem('access_token')
    const response = await fetch(`${API_URL}/buyer/conversations`, {
      headers: { 'Authorization': `Bearer ${token}` }
    })
    return response.json()
  },
  ...
  getMessages: async (conversationId) => {
    const token = localStorage.getItem('access_token')
    const response = await fetch(`${API_URL}/buyer/conversations/${conversationId}/messages`, {
      headers: { 'Authorization': `Bearer ${token}` }
    })
    return response.json()
  },
  ...
  sendMessage: async (conversationId, message) => {
    const token = localStorage.getItem('access_token')
    const response = await fetch(`${API_URL}/buyer/messages`, {
      method: 'POST',
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json'
  ...
  getUnreadCount: async () => {
    const token = localStorage.getItem('access_token')
    const response = await fetch(`${API_URL}/buyer/unread-count`, {
      headers: { 'Authorization': `Bearer ${token}` }
    })
    return response.json()
  },
