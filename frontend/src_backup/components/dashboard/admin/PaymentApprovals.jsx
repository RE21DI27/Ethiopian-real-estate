    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl p-6 max-w-md w-full">
        ...
        <div className="flex gap-3">
          ...
          <button onClick={() => handleReject(selectedPayment?.id)} className="flex-1 px-4 py-2 bg-red-600 text-white rounded-lg">Confirm Reject</button>
        </div>
      </div>
    </div>
  )
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-500">Approve package payments before sellers can add properties</p>
      </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm mb-3">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-green-600">ETB {payment.amount?.toLocaleString()}</p>
                      </div>
                    </div>
                    {payment.status === 'pending' && (
